<template>
  <div
    class="grid w-full grid-cols-2 mx-auto mt-20 border-l border-gray-300 md:mb-8 md:mt-32 xl:w-7/12 md:border-t md:mt-40 md:w-11/12 lg:w-8/12 md:grid-cols-3"
  >
